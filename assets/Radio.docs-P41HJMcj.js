import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./iframe-frnzeJW9.js";import{c as n,l as r,o as i,r as a,s as o,x as s}from"./blocks-D3700PHj.js";import{t as c}from"./mdx-react-shim-BeKI_iHL.js";import{n as l,t as u}from"./Radio.stories-CdRMnRZJ.js";function d(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,...s(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(i,{of:u}),`
...
`,(0,p.jsx)(t.code,{children:`role="radiogroup"`}),` container and provides `,(0,p.jsx)(t.code,{children:`name`}),`, `,(0,p.jsx)(t.code,{children:`size`}),`, `,(0,p.jsx)(t.code,{children:`disabled`}),`, and
`,(0,p.jsx)(t.code,{children:`error`}),` to every `,(0,p.jsx)(t.code,{children:`Radio`}),` descendant via context — so those don't need to be
repeated on each `,(0,p.jsx)(t.code,{children:`Radio`}),`. The group also owns the controlled/uncontrolled
selection:
...
`,(0,p.jsx)(t.code,{children:`value`}),` accepts a `,(0,p.jsx)(t.code,{children:`string`}),`, `,(0,p.jsx)(t.code,{children:`number`}),`, or `,(0,p.jsx)(t.code,{children:`boolean`}),` — `,(0,p.jsx)(t.code,{children:`boolean`}),` is intended
for yes/no groups (e.g. two `,(0,p.jsx)(t.code,{children:`Radio`}),`s with `,(0,p.jsx)(t.code,{children:`value={true}`}),`/`,(0,p.jsx)(t.code,{children:`value={false}`}),`).`]}),`
...
`})}),`
`,(0,p.jsxs)(t.p,{children:[`Pass `,(0,p.jsx)(t.code,{children:`label`}),` to render a heading above the group. It's additive-only — a
`,(0,p.jsx)(t.code,{children:`RadioGroup`}),` without `,(0,p.jsx)(t.code,{children:`label`}),`, `,(0,p.jsx)(t.code,{children:`errorText`}),`, or `,(0,p.jsx)(t.code,{children:`helperText`}),` renders exactly
as before, with no extra wrapper element.`]}),`
`,(0,p.jsxs)(t.p,{children:[(0,p.jsx)(t.code,{children:`required`}),` adds a red asterisk next to `,(0,p.jsx)(t.code,{children:`label`}),` and sets `,(0,p.jsx)(t.code,{children:`aria-required`}),` on
the group. `,(0,p.jsx)(t.code,{children:`error`}),`/`,(0,p.jsx)(t.code,{children:`errorText`}),` mark the group invalid and cascade to every
child `,(0,p.jsx)(t.code,{children:`Radio`}),` — OR'd with each `,(0,p.jsx)(t.code,{children:`Radio`}),`'s own `,(0,p.jsx)(t.code,{children:`error`}),`, so an
individually-errored `,(0,p.jsx)(t.code,{children:`Radio`}),` stays errored even in a valid group, and every
`,(0,p.jsx)(t.code,{children:`Radio`}),` shows as errored when the group itself is. `,(0,p.jsx)(t.code,{children:`errorText`}),` renders below
the group in the danger style and implies `,(0,p.jsx)(t.code,{children:`error`}),`; `,(0,p.jsx)(t.code,{children:`helperText`}),` renders the
same way in a neutral style when there's no `,(0,p.jsx)(t.code,{children:`errorText`}),`.`]}),`
