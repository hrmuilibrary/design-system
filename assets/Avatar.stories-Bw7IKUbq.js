import{a as e,i as t,s as n}from"./preload-helper-BdFrVu1K.js";import{O as r,t as i}from"./iframe-NGpJ9wog.js";import{bt as a,t as o}from"./lucide-react-DU0ceBuS.js";import{n as s,r as c,t as l}from"./Avatar-DqFkRIA4.js";var u=e({AllSizes:()=>w,AllStatuses:()=>S,BrokenImageFallsBackToInitials:()=>g,CustomClassName:()=>T,CustomFallback:()=>v,Editable:()=>E,EditableRejected:()=>D,Group:()=>O,GroupSizes:()=>A,GroupWithMax:()=>k,IconFallback:()=>_,Square:()=>y,WithImage:()=>m,WithInitials:()=>h,WithStatus:()=>b,__namedExportsOrder:()=>j,default:()=>p}),d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M=t((()=>{o(),d=n(r(),1),c(),f=i(),p={title:`Components/Avatar`,component:l,parameters:{layout:`centered`},argTypes:{size:{control:`select`,options:[`2xs`,`xs`,`sm`,`md`,`lg`,`xl`,`2xl`]},status:{control:`select`,options:[void 0,`online`,`offline`,`away`,`busy`]},shape:{control:`select`,options:[`circle`,`square`]}},args:{name:`Ada Lovelace`,size:`md`,shape:`circle`}},m={args:{src:`https://i.pravatar.cc/150?img=12`,alt:`Ada Lovelace`}},h={args:{name:`Ada Lovelace`}},g={name:`Broken image falls back to initials`,args:{src:`https://example.invalid/broken.jpg`,name:`Grace Hopper`}},_={args:{name:void 0}},v={args:{name:void 0,fallback:(0,f.jsx)(a,{className:`h-1/2 w-1/2 text-white/90`})}},y={args:{shape:`square`,name:`Ada Lovelace`}},b={name:`Status - online`,args:{status:`online`}},x=[`online`,`offline`,`away`,`busy`],S={render:e=>(0,f.jsx)(`div`,{className:`flex flex-wrap items-center gap-4`,children:x.map(t=>(0,f.jsxs)(`div`,{className:`flex flex-col items-center gap-2`,children:[(0,f.jsx)(l,{...e,status:t}),(0,f.jsx)(`span`,{className:`text-p-sm text-fg-secondary`,children:t})]},t))})},C=[`2xs`,`xs`,`sm`,`md`,`lg`,`xl`,`2xl`],w={render:e=>(0,f.jsx)(`div`,{className:`flex flex-wrap items-end gap-4`,children:C.map(t=>(0,f.jsxs)(`div`,{className:`flex flex-col items-center gap-2`,children:[(0,f.jsx)(l,{...e,size:t,status:`online`}),(0,f.jsx)(`span`,{className:`text-p-sm text-fg-secondary`,children:t})]},t))})},T={name:`Overriding classes via className`,args:{name:`Ada Lovelace`,className:`ring-2 ring-brand-500 ring-offset-2 rounded-full`}},E={name:`Editable (upload overlay)`,render:()=>{let e=()=>{console.log(`asdada`)};return(0,f.jsx)(`div`,{className:`flex items-end gap-4`,children:[`2xs`,`xs`,`md`,`lg`,`xl`,`2xl`].map(t=>(0,f.jsx)(l,{size:t,name:`Ada Lovelace`,editable:!0,onClick:e,onImageChange:e=>window.alert(`Picked: ${e.name}`)},t))})}},D={name:`Editable — oversized file rejected`,render:()=>{function e(){let[e,t]=(0,d.useState)(null);return(0,f.jsxs)(`div`,{className:`flex flex-col items-start gap-2`,children:[(0,f.jsx)(l,{name:`Ada Lovelace`,editable:!0,maxSizeMB:1,onReject:e=>t(`Rejected "${e.file.name}" (${e.reason})`)}),e&&(0,f.jsx)(`p`,{className:`text-p-sm text-red-700`,children:e})]})}return(0,f.jsx)(e,{})}},O={render:()=>(0,f.jsxs)(s,{size:`md`,children:[(0,f.jsx)(l,{name:`Ada Lovelace`}),(0,f.jsx)(l,{name:`Grace Hopper`}),(0,f.jsx)(l,{src:`https://i.pravatar.cc/150?img=12`,alt:`Alan Turing`}),(0,f.jsx)(l,{name:`Katherine Johnson`}),(0,f.jsx)(l,{name:`Margaret Hamilton`})]})},k={name:`AvatarGroup with max + overflow count`,render:()=>(0,f.jsxs)(s,{size:`md`,max:3,children:[(0,f.jsx)(l,{name:`Ada Lovelace`}),(0,f.jsx)(l,{name:`Grace Hopper`}),(0,f.jsx)(l,{src:`https://i.pravatar.cc/150?img=12`,alt:`Alan Turing`}),(0,f.jsx)(l,{name:`Katherine Johnson`}),(0,f.jsx)(l,{name:`Margaret Hamilton`})]})},A={name:`AvatarGroup across sizes`,render:()=>(0,f.jsx)(`div`,{className:`flex flex-col gap-4`,children:C.map(e=>(0,f.jsxs)(s,{size:e,max:4,children:[(0,f.jsx)(l,{name:`Ada Lovelace`}),(0,f.jsx)(l,{name:`Grace Hopper`}),(0,f.jsx)(l,{name:`Katherine Johnson`}),(0,f.jsx)(l,{name:`Margaret Hamilton`}),(0,f.jsx)(l,{name:`Hedy Lamarr`})]},e))})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  render: () => {
    ...
    return <div className="flex items-end gap-4">
        {(['2xs', 'xs', 'md', 'lg', 'xl', '2xl'] as const).map(s => <Avatar key={s} size={s} name="Ada Lovelace" editable onClick={handleChange} onImageChange={file => window.alert(\`Picked: \${file.name}\`)} />)}
      </div>;
  }
