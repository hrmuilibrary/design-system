import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./iframe-cZVKo6eo.js";import{c as n,l as r,o as i,r as a,s as o,x as s}from"./blocks-Dy_JJ05Q.js";import{t as c}from"./mdx-react-shim-BCFI0Wtm.js";import{n as l,t as u}from"./Accordion.stories-Cf1Ex1YE.js";function d(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,...s(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(i,{of:u}),`
...
`,(0,p.jsxs)(t.p,{children:[`Uncontrolled usage passes `,(0,p.jsx)(t.code,{children:`defaultValue`}),` (a single value — string or number
— for `,(0,p.jsx)(t.code,{children:`single`}),`, an array for `,(0,p.jsx)(t.code,{children:`multiple`}),`) and `,(0,p.jsx)(t.code,{children:`Accordion`}),` tracks open state
...
`,(0,p.jsx)(t.pre,{children:(0,p.jsx)(t.code,{className:`language-tsx`,children:`const [value, setValue] = useState<string | number>('billing');

<Accordion value={value} onValueChange={(next) => setValue(next as string | number)}>
...
`,(0,p.jsxs)(t.p,{children:[`Panels animate open/closed by default (`,(0,p.jsx)(t.code,{children:`animated={true}`}),` on `,(0,p.jsx)(t.code,{children:`Accordion`}),`,
applying to every item) using a CSS-only `,(0,p.jsx)(t.code,{children:`grid-template-rows`}),` transition —
no JS height measurement, so it keeps following content that changes size
while a panel is open. It respects `,(0,p.jsx)(t.code,{children:`prefers-reduced-motion`}),` automatically.
Pass `,(0,p.jsx)(t.code,{children:`animated={false}`}),` to restore the pre-1.x instant toggle, which also
swaps back to a plain `,(0,p.jsx)(t.code,{children:`hidden`}),` attribute on the panel instead of the
animated grid wrapper.`]}),`
`,(0,p.jsxs)(t.p,{children:[(0,p.jsx)(t.code,{children:`showDivider`}),` renders a `,(0,p.jsx)(t.code,{children:`Divider`}),` between each item's header and its
content.`]}),`
